package terminal_code.backend.workspace.application;

import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import terminal_code.backend.common.error.ResourceNotFoundException;
import terminal_code.backend.common.error.WorkspaceNotFoundException;
import terminal_code.backend.workspace.domain.*;
